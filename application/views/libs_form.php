	    ...
	    <div class="container-fluid">
	        ...
	        <div class="card shadow mb-4 mt-2">
	            ...
	            <div class="offset-md-2 col-md-8 offset-md-2 card-body">
	            	<form action="<?php echo base_url('libs/proses_tambah'); ?>"  method="post" enctype="multipart/form-data">
					  ...
					  <div class="form-group">
					    ...
					    <input type="text" name="nama_file" class="form-control" placeholder="Isi Nama File" required>
					  </div>
					  <div class="form-group">
